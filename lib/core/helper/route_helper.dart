...
import 'package:anycallmobile_trainingcenter/data/model/assignment_model/assignment_model.dart';
import 'package:anycallmobile_trainingcenter/feature/allCourse/all_course_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/assignment/assignment_details_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/assignment/assignment_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/change_password/change_password_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/email_verification_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/forgot_password/forgot_password_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/bookDetails/book_details_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/bookStore/book_store_screen.dart';
import 'package:anycallmobile_trainingcenter/controller/splash_controller.dart';
import 'package:anycallmobile_trainingcenter/core/initial_binding/initial_binding.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/forgot_password/new_pass_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/phoneSignIn/phone_sign_in.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/phone_signup_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/sign_in_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/sign_up_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/auth/phoneSignIn/verification_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/cart/cart_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/cheekOut/payment_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/classRoom/learning_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/contact_us_page.dart';
import 'package:anycallmobile_trainingcenter/feature/conversation/view/conversation_list.dart';
import 'package:anycallmobile_trainingcenter/feature/coupon/coupon_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/courseCategory/course_category.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/course_details_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/html/html_viewer_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/invoice/invoice_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/landing/landing_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/new_feature/all_courses_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/new_feature/blog_details_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/new_feature/meeting_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/new_feature/my_quiz_list_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/new_feature/photo_view.dart';
...
import 'package:anycallmobile_trainingcenter/feature/new_feature/quiz_screen.dart';
// import 'package:anycallmobile_trainingcenter/feature/meeting/meeting_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/not_logged_in_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/cheekOut/cheek_out_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/notification/notification_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/onboarding/view/onboarding_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/order/order_history_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/organization/organization_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/profile/edit_profile_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/profile/profile_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/profile/widgets/certificate_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/quiz/quiz_detail_page.dart';
import 'package:anycallmobile_trainingcenter/feature/quiz/quiz_result_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/quiz/quiz_start_page.dart';
import 'package:anycallmobile_trainingcenter/feature/resources/resource_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/root/view/not_found_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/root/view/update_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/searchScreen/search_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/settings/settings_screen.dart';
import 'package:anycallmobile_trainingcenter/feature/splash_screen.dart';
import 'package:anycallmobile_trainingcenter/utils/html_type.dart';
...
class RouteHelper {
  ...
  //!new
  static const String quizCourseScreen = '/quizCourseScreen';
  static const String myQuizListScreen = '/myQuizListScreen';
  static const String quizScreen = '/quizScreen';
  static const String quizExamResultScreen = '/quizExamResultScreen';
  ...
  static String getLearningScreen(String courseID, String courseTitle) =>
      '$learningScreen?courseID=$courseID&courseTitle=$courseTitle';
  ...
  static String getQuizCourseScreen() => quizCourseScreen;
  static String getMyQuizListScreen() => myQuizListScreen;
  static String getQuizScreen() => quizScreen;
  static String getQuizExamResultScreen() => quizExamResultScreen;
  static String getPhotoView() => photoView;
  static String getAllCoursesScreen() => allCoursesScreen;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: meetingScreen, page: () => MeetingScreen()),
    ...
    GetPage(name: quizCourseScreen, page: () => QuizCourseScreen()),
    GetPage(name: myQuizListScreen, page: () => MyQuizListScreen()),
    GetPage(name: quizScreen, page: () => QuizScreen()),
    GetPage(name: quizExamResultScreen, page: () => QuizExamResultScreen()),
    GetPage(name: photoView, page: () => PhotoView()),
    GetPage(name: allCoursesScreen, page: () => AllCoursesScreen()),
