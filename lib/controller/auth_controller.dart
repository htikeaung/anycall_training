...
import 'package:anycallmobile_trainingcenter/data/model/signup_body.dart';
import 'package:anycallmobile_trainingcenter/data/model/social_login_body.dart';
...
class AuthController extends GetxController implements GetxService {
  ...
  Future<void> login() async {
    ...
    if (response != null && response.statusCode == 200) {
      ...
      await Get.find<MyCourseController>().getMyCourseList();
