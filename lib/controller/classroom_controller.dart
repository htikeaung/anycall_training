...
import 'package:anycallmobile_trainingcenter/data/model/classroom/classroom/classroom.dart';
import 'package:anycallmobile_trainingcenter/feature/classRoom/widget/audio_player.dart';
import 'package:anycallmobile_trainingcenter/repository/classroom_repo.dart';
import 'package:anycallmobile_trainingcenter/repository/course_progress_repository.dart';
...
class ClassroomController extends GetxController implements GetxService {
  ...
  void updateVideoUrl({
    ...
    Get.put(MyVideoPlayerController())
        .playVideo(url, courseID, lessonId, sectionId);
    update();
  }
  ...
  Future<void> getCourseSectionData({required int courseID}) async {
    ...
    if (response != null && response.statusCode == 200) {
      ...
      log("The course details is ${response.body}");
    }
    isLoading = false;
    update();
  }
