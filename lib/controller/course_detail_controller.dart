...
import 'package:anycallmobile_trainingcenter/data/model/course_detail/course_detail.dart';
import 'package:anycallmobile_trainingcenter/repository/course_detail_repo.dart';
...
class CourseDetailController extends GetxController implements GetxService {
  ...
  void share() {
    Share.share(
        "${Config.baseUrl.replaceAll('api', 'course')}${_courseDetail?.data.slug ?? ''}");
  }
