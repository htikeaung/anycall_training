...
import 'package:anycallmobile_trainingcenter/data/model/user_model/user_data.dart';
import 'package:anycallmobile_trainingcenter/data/model/user_model/user_model.dart';
...
class UserController extends GetxController implements GetxService {
  ...
  Future<void> editProfile() async {
    ...
    if (response != null && response.statusCode == 200) {
      ...
      log("The edit profile data is $response");
      customSnackBar("${response.body['message']}".tr, isError: false);
    } else {
      log("The issue is $response");
