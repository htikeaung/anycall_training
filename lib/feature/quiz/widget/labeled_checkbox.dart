      ...
      children: [
        SizedBox(
          ...
          child: Checkbox(
            ...
            //     return checkedColor ?? Theme.of(context).primaryColor;
            //   }
            //   return uncheckedColor ?? cLineColor; // cLineColor equivalent
            // }),
            side: MaterialStateBorderSide.resolveWith(
              ...
              if (!states.contains(MaterialState.selected)) {
                return BorderSide(
                    color:
                        uncheckedColor ?? cLineColor); // cLineColor equivalent
              }
              return BorderSide(color: cLineColor);
            }),
          ),
        ),
        Expanded(
