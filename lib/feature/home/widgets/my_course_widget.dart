...
class MyCourseWidget extends StatelessWidget {
  ...
  const MyCourseWidget({Key? key, this.myCourseList, this.callback})
      : super(key: key);
  ...
  Widget myCourseItem(int index, BuildContext context, MyCourse myCourse) {
    return Padding(
      ...
      child: InkWell(
        onTap: () => Get.toNamed(RouteHelper.getLearningScreen(
            myCourse.id.toString(), myCourse.title!)),
        radius: 6,
        child: Container(
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation<Color>(Get.isDarkMode
                        ? const Color(0xffff0102).withOpacity(.5)
                        : Theme.of(context).primaryColor.withOpacity(.5)),
                    backgroundColor: Get.isDarkMode
                        ? const Color(0xffff0102).withOpacity(.1)
