...
import 'package:anycallmobile_trainingcenter/data/model/conversation/all_messages.dart';
import 'package:anycallmobile_trainingcenter/data/model/conversation/chat_list.dart';
import 'package:anycallmobile_trainingcenter/feature/conversation/widgets/chat_app_bar.dart';
import 'package:anycallmobile_trainingcenter/feature/conversation/widgets/input_widget.dart';
import 'package:anycallmobile_trainingcenter/feature/conversation/widgets/video_message_builder.dart';
import 'package:anycallmobile_trainingcenter/repository/chat_repository.dart';
...
class _ChatScreenState extends State<ConversationScreen>
  ...
  Future<void> _handleEndReached() async {
    final response = await ChatRepository(Get.find())
        .getAllMessages(chatRoomId: chatUser.chatRoomId, page: _page);
  ...
  void startTimer() async {
    _timer = Timer.periodic(const Duration(seconds: 5), (timer) async {
      final response = await ChatRepository(Get.find())
          .getAllMessages(chatRoomId: chatUser.chatRoomId, page: 1);
