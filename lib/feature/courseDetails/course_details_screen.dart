...
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/button_section.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/course_curriculum.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/course_features.dart';
import 'package:anycallmobile_trainingcenter/feature/common/course_instructor.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/course_overview.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/course_resource.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/course_review.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/frequently_ask_question.dart';
import 'package:anycallmobile_trainingcenter/feature/common/organization.dart';
import 'package:anycallmobile_trainingcenter/feature/courseDetails/widgets/related_course.dart';
...
class _CourseDetailsScreenState extends State<CourseDetailsScreen> {
  ...
  void dispose() {
    ...
    try {
      ...
      log("Controller was not initialized or already disposed: $e");
    }
    super.dispose();
  }
  ...
  Widget mainUI(BuildContext context, CourseDetail courseDetail,
    ...
    if (courseDetail.data.videoSource == "youtube") {
      _controller = YoutubePlayerController(
          initialVideoId:
              YoutubePlayer.convertUrlToId(courseDetail.data.videoLink!)!,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
          ...
          children: [
            controller.selectedVideoUrl != null &&
                    controller.playNewVideo == true
                ? courseDetail.data.videoSource == "youtube"
                    ? Container(
                ...
                : Container(
                    ...
                    child: Center(
                      child: IconButton(
                          onPressed: () {
                            controller.updateVideoUrl(true,
                                courseDetail.data.videoLink ?? "", 0, '0', '0');
                          },
